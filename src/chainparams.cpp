...
{
    const char* pszTimestamp = "Asli Gulbahar, 20-01-1985 06:45";
    const CScript genesisOutputScript = CScript() << ParseHex("014534710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621858515, 2000763455, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfd37451e104f1917c66278fb582a0cccd50ae7e777871ac1337f07ea03c691c1"));
        assert(genesis.hashMerkleRoot == uint256S("0x1e63b2b49d656ca0d285685028e541e6839fdfdcf94c9d93bf393a473af0e4e5"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("143.244.160.58", "143.244.160.58", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("cozycointools.com", "dnsseed.cozycointools.com"));
        //vSeeds.push_back(CDNSSeedData("cozycoinpool.org", "dnsseed.cozycoinpool.org"));
        //vSeeds.push_back(CDNSSeedData("koin-project.com", "dnsseed.koin-project.com"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);  //public address prefix C
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xfd37451e104f1917c66278fb582a0cccd50ae7e777871ac1337f07ea03c691c1"))
        ...
        chainTxData = ChainTxData{
            ...
            1621858515, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621858515, 312941, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb91e6fd2d9a33fcc65414b133afd2f30ed9c9aff6b798fa3ae05ab76aec49cfc"));
        assert(genesis.hashMerkleRoot == uint256S("0x1e63b2b49d656ca0d285685028e541e6839fdfdcf94c9d93bf393a473af0e4e5"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("143.244.160.58", "143.244.160.58"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.cozycoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xb91e6fd2d9a33fcc65414b133afd2f30ed9c9aff6b798fa3ae05ab76aec49cfc")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1621858515, 0, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x03639a6ee5edfca83e10e71ffc58f243eec2fbfea1e5f81817f3f28a64615ad4"));
        assert(genesis.hashMerkleRoot == uint256S("0x1e63b2b49d656ca0d285685028e541e6839fdfdcf94c9d93bf393a473af0e4e5"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x03639a6ee5edfca83e10e71ffc58f243eec2fbfea1e5f81817f3f28a64615ad4"))
        };
