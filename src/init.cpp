...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/cozycoin-project/cozycoin>";
    const std::string URL_WEBSITE = "<https://cozycoin.org>";
