...
const char * const BITCOIN_CONF_FILENAME = "cozycoin.conf";
const char * const BITCOIN_PID_FILENAME = "cozycoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cozycoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Cozycoin";
#else
    // Unix
    return pathRet / ".cozycoin";
#endif
#endif
}
