...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s cozycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cozycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cozycoin transaction") + "\n" +
              "  cozycoin-tx [options] -create [commands]   " + _("Create hex-encoded cozycoin transaction") + "\n" +
              "\n";
